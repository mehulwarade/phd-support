...
do
	...
	do
		...
		jobstate_file=$index_node'n_i'$workflow_size'_40k-jobstate.log'
		mysql_table=$index_node'n_i'$workflow_size'_40k'

		echo 'Processing: ' $jobstate_file ' using table: ' $mysql_table

		# echo 'size: ' $workflow_size ' nodes: ' $index_node
		start=$(awk '{print $1}' $index_node'n_i'$workflow_size'_40k-jobstate.log' | head -n 1)
    	end=$(awk '{print $1}' $index_node'n_i'$workflow_size'_40k-jobstate.log' | tail -n 1)
		...
		echo 'End Processing: ' $index_node'n_i'$workflow_size'_40k-jobstate.log'
	done
done
